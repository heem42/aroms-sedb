...
public class chef_display_adapter extends RecyclerView.Adapter<chef_display_adapter.chef_display_adapterViewHolder>  {
        ...
        @Override
        public chef_display_adapterViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(mContext).inflate(R.layout.chef_display_row, parent, false);
            return new chef_display_adapterViewHolder(v);
        }

        @Override
        public void onBindViewHolder(chef_display_adapterViewHolder holder, int position) {
